    ...
    return (
        <main className="min-h-screen overflow-hidden bg-[#fff9f4] text-[#201816]">
            ...
            <footer className="border-t border-[#ead8ca] bg-[#fffaf6]">
                <div className="mx-auto grid max-w-7xl gap-0 px-6 py-8 lg:grid-cols-[1fr_3fr] lg:px-10">
                    <div className="flex flex-col items-start w-60 gap-1">
                        <strong className="block font-serif text-xl ">Contemporaneo</strong>
                        <span className="text-sm text-[#5f514c]">© 2026 Plataforma de musica clasica contemporanea</span>
                        <span className="text-sm text-[#5f514c]">Creación de Miguel Nicolas</span>
                    </div>
